<?php
	...
	{		
		...
		$result1 = mysqli_query("SELECT MAX(notif_no) FROM notification_system",$conn);
	...
	function display_notification($user){
		...
		$result1 = mysqli_query("SELECT count(notif_no) FROM notification_system",$conn);
		$counter = mysqli_fetch_array($result1);
		
		$result1 = mysqli_query("SELECT sender FROM notification_system",$conn);
		$result2 = mysqli_query("SELECT notif_type FROM notification_system",$conn);
		$result3 = mysqli_query("SELECT receiver FROM notification_system",$conn);
